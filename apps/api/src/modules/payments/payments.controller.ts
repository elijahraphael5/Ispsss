import { Controller, Get, Post, Patch, Param, Body, Headers, Req, UseGuards, Query } from '@nestjs/common';
...
export class PaymentsController {
  ...
  handlePaystack(@Req() req: any, @Headers('x-paystack-signature') signature: string) {
    return this.service.handlePaystackWebhook(req.body, signature);
  }
