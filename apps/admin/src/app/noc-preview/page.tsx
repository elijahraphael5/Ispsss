...
import { NocApiProvider } from './NocApiContext';
...
const TABS = ['NAS', 'PPPoE Profiles', 'PPPoE Users'];

export default function NocPreviewPage() {
  ...
  return (
    <NocApiProvider client={mockApi}>
      <div className="page-title-row">
        <h1 className="page-title">NOC — RADIUS Configuration (Preview)</h1>
      </div>
      ...
      {tab === 'PPPoE Profiles' && <ProfilesTab toast={toast} />}
      {tab === 'PPPoE Users' && <UsersTab toast={toast} />}
    </NocApiProvider>
  );
}
